"""Sprint 10K — build the synthetic NDA input document.

Direct copy of Sprint 10E's ``build_input.py``. Same NDA, so the output
is directly comparable to 10E / 10F / 10G / 10H-control / 10I-MiniMax /
10I-Sonnet / 10J. Only the containing directory differs.

Run directly to (re)generate the document::

    python src/redline/experiments/sprint-10k/build_input.py
"""
