"""Sprint 10J — build the synthetic NDA input document.

Same clause structure as every prior sprint (10D/E/F/G/H/I): a ten-clause
mutual NDA with §9 "Governing Law and Dispute Resolution" as the clause
under test. Copied into 10J's feature branch so the input can be
regenerated without touching 10E's on-main artefacts.

Run directly to (re)generate the document::

    python -m src.experiments.sprint-10j.build_input
"""
